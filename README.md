...
Можно использовать как синхронный API, так и асинхронный. Выбор сделан на перспективу и для удобства пользователей
...
[Асинхронное API](https://github.com/SergeiLisovoi22/architecture-warmhouse-main/blob/warmhouse/apps/smart_home/api/async_api.yaml)
[Cинхронное API](https://github.com/SergeiLisovoi22/architecture-warmhouse-main/blob/warmhouse/apps/smart_home/api/sync_api.yaml)
[Swagger](https://github.com/SergeiLisovoi22/architecture-warmhouse-main/blob/warmhouse/apps/smart_home/temperature-api/docs/docs.go)
